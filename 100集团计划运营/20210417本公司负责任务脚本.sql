...
BEGIN
    ...
    TAB_WHERE_EXPRESSION_SQL => TAB_WHERE_EXPRESSION_SQL,
...
-------------------------------------------------------------------------------------------内容
noed_sql:=proj_noed_sql||tab_where_expression_sql||'
                UNION All
          '||special_noed_sql||tab_where_expression_sql||' ';
join_where_exec:='                        
             ('||noed_sql||') node 
             ' ||join_where_sql||'';
end;

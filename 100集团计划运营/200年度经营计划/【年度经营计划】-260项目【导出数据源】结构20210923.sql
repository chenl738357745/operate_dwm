...
Union All
Select 'projsheet2' "sheetID",'附表2-项目投资计划表' "sheetName",'              公司       项目 '||planyear||' 年度房地产开发项目投资计划表' "topDescription",'DARK_TEAL' "headerBgColor",'PALE_BLUE' "headerFontColor",2 "sheetOrder",1 "isUseRowCollapse",1 "isDefaultCollapseRow" ,0 As "frozenRowindex",2 As "frozenColumnindex",'GREY_25_PERCENT' As "formulaBgColor",'WHITE' "topDescriptionBgColor",'BLACK' "topDescriptionFontColor",'center' "topDescriptionTextalign",'15' "topDescriptionTextSize" From Dual
Union All

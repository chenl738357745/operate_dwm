...
--------------------------------------------------------
  ...
  CREATE OR REPLACE VIEW "V_POM_PJPLAN_EXM_SOCRE" ("RANK", "PLAN_TYPE", "ID", "PARENT_ID", "ORG_NAME", "ORGCODE", "PLANYEAR", "PLANQUATOR", "PLANMOTH", "应完成", "已完成", "SUMNODESCORE", "已完成总分", "动态得分", "里程碑应完成", "里程碑已完成", "一级节点应完成", "一级节点已完成", "二级节点应完成", "二级节点已完成", "三级节点应完成", "三级节点已完成", "里程碑绿灯", "一级节点绿灯", "二级节点绿灯", "三级节点绿灯", "里程碑黄灯", "一级节点黄灯", "二级节点黄灯", "三级节点黄灯", "里程碑红灯", "一级节点红灯", "二级节点红灯", "三级节点红灯", "CTYPE") AS SELECT  
...
,A.ID AS PLANID ,A.PLAN_NAME,a.PLAN_TYPE
	...
	,TO_CHAR( A1.PLAN_END_DATE, 'Q' ) 	AS "PLANQUATOR"

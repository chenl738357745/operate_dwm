...
SELECT 'groupsheet1' "sheetID",1 "fieldLevel",0 "isHide",1 "isEnd", 'groupsheet1序号id' "fieldId",'字段中文名' "lable",'groupsheet1序号' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
Union All
---------------------------------sheet2
---必须层
SELECT 'groupsheet2' "sheetID",1 "fieldLevel",1 "isHide",1 "isEnd", 'id' "fieldId",'id' "lable",'id' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
SELECT 'groupsheet2' "sheetID",1 "fieldLevel",0 "isHide",1 "isEnd", 'groupsheet2ParentId' "fieldId",'parentid' "lable",'parentid' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
---第一层
SELECT 'groupsheet2' "sheetID",1 "fieldLevel",1 "isHide",1 "isEnd", 'id' "fieldId",'id' "lable",'id' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
SELECT 'groupsheet2' "sheetID",1 "fieldLevel",0 "isHide",1 "isEnd", 'groupsheet2序号id' "fieldId",'序号' "lable",'groupsheet2序号' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",1 "fieldLevel",0 "isHide",1 "isEnd",'城市/项目名称' "fieldId",'城市/项目名称' "lable",'OBJECT_NAME' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
...
---第二层
union all
SELECT 'groupsheet2' "sheetID",2 "fieldLevel",0 "isHide",0 "isEnd", '截至2021年底' "fieldId",'截至'||to_char(planyear-1)||'年底' "lable",'截至2021年底' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'2021年集团（区域）动态现金流' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",2 "fieldLevel",0 "isHide",0 "isEnd",'2022年资金来源计划' "fieldId",planyear||'年资金来源计划' "lable",'2022年资金来源计划' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'2021年集团（区域）动态现金流' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",2 "fieldLevel",0 "isHide",0 "isEnd",'2022年资金运用计划' "fieldId",planyear||'年资金运用计划' "lable",'2022年资金运用计划' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'2021年集团（区域）动态现金流' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",2 "fieldLevel",0 "isHide",0 "isEnd",'2022年当年现金流情况展示窗' "fieldId",planyear||'年当年现金流情况展示窗' "lable",'2022年当年现金流情况展示窗' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",0 "fieldOrder",'2021年集团（区域）动态现金流' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
---第三层
union all
SELECT 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd", '2021年底-期末资金余额' "fieldId",'2021年底-期末资金余额' "lable",'年底-期末资金余额' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",1 "fieldOrder",'截至2021年底' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual

union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'销售回款' "fieldId",'销售回款' "lable",'销售回款' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",2 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'租金收入' "fieldId",'租金收入' "lable",'租金收入' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",3 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'净增贷款' "fieldId",'净增贷款' "lable",'净增贷款' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",4 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'代收款' "fieldId",'代收款' "lable",'代收款' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",5 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'股东投入' "fieldId",'股东投入' "lable",'股东投入' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",6 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'往来投入' "fieldId",'往来投入' "lable",'往来投入' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",7 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'其他投入' "fieldId",'其他投入' "lable",'其他投入' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",8 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'资金来源合计' "fieldId",'资金来源合计' "lable",'资金来源合计' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",9 "fieldOrder",'2022年资金来源计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual

union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'土地费用' "fieldId",'土地费用' "lable",'土地费用' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",10 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'工程性支出' "fieldId",'工程性支出' "lable",'工程性支出' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",11 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'开发间接费' "fieldId",'开发间接费' "lable",'开发间接费' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",12 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'期间费用' "fieldId",'期间费用' "lable",'期间费用' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",13 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'税金' "fieldId",'税金' "lable",'税金' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",14 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'代付款' "fieldId",'代付款' "lable",'代付款' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",15 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'其他支出' "fieldId",'其他支出' "lable",'其他支出' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",16 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'往来支出' "fieldId",'往来支出' "lable",'往来支出' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",17 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'资金运用小计' "fieldId",'资金运用小计' "lable",'资金运用小计' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",18 "fieldOrder",'2022年资金运用计划' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual

union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'资金净流量' "fieldId",'资金净流量' "lable",'资金净流量' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",19 "fieldOrder",'2022年当年现金流情况展示窗' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'展示窗-期末资金余额' "fieldId",'期末资金余额' "lable",'展示窗-期末资金余额' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",20 "fieldOrder",'2022年当年现金流情况展示窗' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
union all
Select 'groupsheet2' "sheetID",3 "fieldLevel",0 "isHide",1 "isEnd",'可动用资金' "fieldId",'可动用资金' "lable",'可动用资金' "field",'auto' "width",'left' "align",'#,##0.00' "dataFormat",21 "fieldOrder",'2022年当年现金流情况展示窗' "parentId",'left' "textAlign",1 "isColumnMerge"  From Dual
---------------------------------sheet3
union all

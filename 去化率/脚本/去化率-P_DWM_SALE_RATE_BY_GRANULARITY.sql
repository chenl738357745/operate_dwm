...
--    INSERT INTO  DWM_SALE_RATE_PROJECT_HISTORY
 --   select * from  DWM_SALE_RATE_BY_GRANULARITY where REMARK=dwm_REMARK;
...
,REMARK---【52】备注信息
    ...
    data_granularity,
    created,
    remark from  TMP_SALE_RATE_BY_GRANULARITY where id=spid
union all 
select  project_id||PRODUCT_NAME,project_id,
